      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            {/* UBA Badge */}
            <div className="inline-flex items-center space-x-2 bg-amber-500/10 border border-amber-500/30 rounded-full px-4 py-1.5 text-amber-300">
            ...
            <div className="space-y-4">
              <h2 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-semibold tracking-tight text-white leading-tight">
                El respaldo <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-200">profesional</span> que tu proyecto necesita
              </h2>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-2">
              <div className="bg-slate-900/60 border border-slate-800/80 p-3.5 rounded-xl">
                <span className="block font-serif text-2xl font-bold text-amber-400">100%</span>
                <span className="text-[11px] font-sans text-slate-400 uppercase tracking-widest mt-1 block">Atención Personalizada</span>
              </div>
              <div className="bg-slate-900/60 border border-slate-800/80 p-3.5 rounded-xl">
                <span className="block font-serif text-2xl font-bold text-amber-500">UBA</span>
              ...
              <div className="bg-slate-900/60 border border-slate-800/80 p-3.5 rounded-xl col-span-2 sm:col-span-1">
                <span className="block font-serif text-2xl font-bold text-amber-400">Online</span>
          ...
          <div className="lg:col-span-5 relative mt-6 lg:mt-0">
            <div className="relative mx-auto max-w-[420px] lg:max-w-none">
              ...
              <div className="absolute -inset-1.5 bg-gradient-to-r from-amber-500 to-amber-600 rounded-2xl blur opacity-20 group-hover:opacity-30 transition duration-1000" />
              ...
              <div className="relative bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-2xl">
                ...
                <div className="space-y-3.5 mb-6">
                  <h4 className="text-[11px] font-sans font-semibold tracking-wider uppercase text-amber-400">
